...
use biome_js_analyze::{
    analyzers::style::use_consistent_array_type, semantic_analyzers::style::use_naming_convention,
};

use super::eslint::Shorthand;
...
pub(crate) struct NamingConventionSelection {
    pub(crate) selector: Shorthand<Selector>,
